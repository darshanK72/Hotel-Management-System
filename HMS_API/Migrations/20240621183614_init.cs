    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "Hotel owner", "Owner" });

            migrationBuilder.InsertData(
                table: "Roles",
                columns: new[] { "RoleId", "Description", "UserRole" },
                values: new object[] { 2, "Hotel manager", "Manager" });

            migrationBuilder.InsertData(
                table: "Roles",
                columns: new[] { "RoleId", "Description", "UserRole" },
                values: new object[] { 3, "Front desk staff", "Receptionist" });

            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "UserId", "Email", "Password", "RoleId", "Username" },
                values: new object[] { 1, "admin@example.com", "owner123", 1, "owner" });

            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "UserId", "Email", "Password", "RoleId", "Username" },
                values: new object[] { 2, "manager@example.com", "manager123", 2, "manager" });
